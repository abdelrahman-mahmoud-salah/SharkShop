...
class _ApiManager implements ApiManager {
  ...
  @override
  Future<UserInfoModelRepo> userInfo() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserInfoModelRepo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserInfoModelRepo _value;
    try {
      _value = UserInfoModelRepo.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<ProductRepoModel>> getAllProduct() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductRepoModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<ProductRepoModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              ProductRepoModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<List<GetAllUsersRepoModel>> getAllUser() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetAllUsersRepoModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GetAllUsersRepoModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              GetAllUsersRepoModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<List<GetAllCategoryRepoModel>> getAllCategory() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetAllCategoryRepoModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GetAllCategoryRepoModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              GetAllCategoryRepoModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<UploadImageResourse> uploadImage(File parts) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    _data.files.add(MapEntry(
      ...
      MultipartFile.fromFileSync(
        parts.path,
        filename: parts.path.split(Platform.pathSeparator).last,
      ),
    ));
  ...
  Future<CreateCategoryModelRepo> createCategory(
      CreateCatecoryModelRequest createCategoryModelRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(createCategoryModelRequest.toJson());
    final _options = _setStreamType<CreateCategoryModelRepo>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
